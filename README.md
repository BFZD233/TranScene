...
├── datasets
    ...
    ├── TranScene
        ...
        └── right
```
<p> Our TranScene dataset can be downloaded from <a href="https://drive.google.com/drive/folders/127w9Fmpdvc9yagWNAiuCazYmec4NXrEC/view?usp=sharing">Google Drive</a>. </p>
